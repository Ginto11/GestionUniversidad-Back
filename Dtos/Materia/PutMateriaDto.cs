...
namespace GestionUniversidad.Dtos.Materia
{
    ...
    public class PutMateriaDto
    {
        ...
        [Range(1, int.MaxValue, ErrorMessage = "El estadoMateriaId debe ser mayor a 0.")]
        public required int EstadoMateriaId { get; set; }

        [Range(1, int.MaxValue, ErrorMessage = "El docenteId debe ser mayor a 0.")]
        public required int DocenteId { get; set; }

        [Range(1, int.MaxValue, ErrorMessage = "El programaId debe ser mayor a 0.")]
